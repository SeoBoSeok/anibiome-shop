...
<div class="content_wrap sub">
    <section class="sub_visual">
        <div class="sub_top_bg"><img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/sub_top_bg.png"></div>
                    ...
                    <li>
                        ...
                        <div class="detail_group">
                            <div class="member" onclick="mdShow('mb_owonseok')">
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_owonseok.png">
                                    <div class="hover"></div>
                                </div>
                            ...
                            <div class="member" onclick="mdShow('mb_leeseunggeun')">
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_leeseunggeun.png">
                                    <div class="hover"></div>
                                </div>
                                <span class="tag_founder">Founder</span>
                    ...
                    <li>
                        ...
                        <div class="detail_group">
                            <div class="member" onclick="mdShow('mb_choseongbeom')">
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_choseongbeom.png">
                                    <div class="hover"></div>
                                </div>
                                <span class="tag_founder">Founder</span>
                            ...
                            <div class="member"  onclick="mdShow('mb_baekseungjun')">
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_baekseungjun.png">
                                    <div class="hover"></div>
                                </div>
                                <span class="tag_founder">Founder</span>
                            ...
                            <div class="member"  onclick="mdShow('mb_kimminsu')">
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_kimminsu.png">
                                    <div class="hover"></div>
                                </div>
                                <span class="tag_founder">Founder</span>
                    ...
                    <li>
                        ...
                        <div class="detail_group">
                            <div class="member" onclick="mdShow('mb_ohgyusil')">
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_ohgyusil.png">
                                    <div class="hover"></div>
                                </div>
                            ...
                            <div class="member" onclick="mdShow('mb_sonhaesu')">
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_sonhaesu.png">
                                    <div class="hover"></div>
                                </div>
                    ...
                    <li>
                        ...
                        <div class="detail_group">
                            <div class="member" onclick="mdShow('mb_parkseil')">
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_parkseil.png">
                                    <div class="hover"></div>
                                </div>
                            ...
                            <div class="member" onclick="mdShow('mb_kimyeongin')" >
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_kimyeongin.png">
                                    <div class="hover"></div>
                                </div>
                            ...
                            <div class="member" onclick="mdShow('mb_leemijin')">
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_leemijin.png">
                                    <div class="hover"></div>
                                </div>
                            ...
                            <div class="member" onclick="mdShow('mb_leeseungjin')">
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_leeseungjin.png">
                                    <div class="hover"></div>
                                </div>
                            ...
                            <div class="member" onclick="mdShow('mb_parkdaesik')">
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_parkdaesik.png">
                                    <div class="hover"></div>
                                </div>
                            ...
                            <div class="member" onclick="mdShow('mb_leejeongmin')">
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_leejeongmin.png">
                                    <div class="hover"></div>
                                </div>
                            ...
                            <div class="member" onclick="mdShow('mb_leeseunggon')">
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_leeseunggon.png">
                                    <div class="hover"></div>
                                </div>
                            ...
                            <div class="member" onclick="mdShow('mb_kimjongman')">
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_kimjongman.png">
                                    <div class="hover"></div>
                                </div>
                            ...
                            <div class="member" onclick="mdShow('mb_leejinmin')">
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_leejinmin.png">
                                    <div class="hover"></div>
                                </div>
                            ...
                            <div class="member" onclick="mdShow('mb_chaeminju')">
                                <div class="img">
                                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/member_chaeminju.png">
                                    <div class="hover"></div>
                                </div>
