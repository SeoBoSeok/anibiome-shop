...
<div class="content_wrap sub">
    ...
    <section class="mission_vision">
        <div class="section_padding box_width">
            <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/sub_mission_con01.png" class="m_none_tab_on"  style="max-width:1150px;">
            <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/sub_mission_con01_m.png" class="pc_tab_none">
        </div>
        <div class="img_slide_dog section-title scroll_slide_group hidden">
            <div class="section-title" data-aos="fade-right">
                <span class="paralax-title">
                    <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/sub_mission_img01.png">
                </span>
            </div>
        </div>
        <div class="section_padding box_width">
            ...
            <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/sub_mission_con02.png" class="m_none_tab_on mt_50" style="max-width:1150px;" data-aos="flip-up">
            <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/sub_mission_con02_m.png" class="pc_tab_none mt_20">
        </div>
        ...
        <div class="area_study section_padding box_width">
            <img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images/sub_mission_img02.png" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="1000">
            <div class="list">
