...
<div class="content_wrap sub">
		...
		<section class="targetmarket">
			<div class="section_padding box_width">
				...
				<img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images2/sub_targetmarket_img01.png" data-aos="fade-left">
			</div>
			<div class="rnd">
				<div class="cover">
				...
				<div class="content box_width">
					<img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images2/sub_targetmarket_img03.png" style="max-width:1180px; margin:0 auto; display: block;" class="m_none_tab_on">
					<img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images2/sub_targetmarket_img03_m.png" class="pc_tab_none">
				</div>
			</div>
			<div class="box_width section_padding platform_area">
				...
				<div class="sub_small_sectionbox" data-aos="fade-up">
					...
					<div class="content">
						<img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images2/sub_targetmarket_img04.png" class="m_none_tab_on">
						<img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images2/sub_targetmarket_img04_m.png"  class="pc_tab_none">
					</div>
				</div>
				<div class="sub_small_sectionbox mt_40" data-aos="fade-up">
					<p class="tit">노령동물힐링센터 / 닥터오 힐링 프로그램</p>
					<div class="content">
						<img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images2/sub_targetmarket_img05.png" class="m_none_tab_on">
						<img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images2/sub_targetmarket_img05_m.png"  class="pc_tab_none">
					</div>
				</div>
			</div>
...
펫푸드, 기능성간식, 영양보조제 개발
					...
					<img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images2/sub_targetmarket_img06.png" class="m_none_tab_on">
					<img src="/<?php echo G5_THEME_DIR.'/basic_anibiom/'; ?>images2/sub_targetmarket_img06_m.png"  class="pc_tab_none">
				</div>
			</div>
